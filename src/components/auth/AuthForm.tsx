    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 p-4">
      <Card className="w-full max-w-md min-h-[580px] flex flex-col">
        ...
        <CardContent className="flex-1 flex flex-col justify-between">
            ...
            <div className="flex flex-col items-center space-y-3 pt-4 border-t">
              ...
              <div className="flex items-center justify-center space-x-4">
                ...
                <Button 
                  variant="outline" 
                  size="icon"
                  className="w-12 h-12 rounded-full border-2 hover:border-blue-500 hover:bg-blue-50 transition-all duration-200" 
                  onClick={() => handleOAuthLogin('google')}
                  disabled={isLoading}
                  title="使用 Google 账户登录"
                >
                ...
                <Button 
                  variant="outline" 
                  size="icon"
                  className="w-12 h-12 rounded-full border-2 hover:border-gray-700 hover:bg-gray-50 transition-all duration-200" 
                  onClick={() => handleOAuthLogin('github')}
                  disabled={isLoading}
                  title="使用 GitHub 账户登录"
                >
          ...
          {/* 游客模式按钮 */}
          <div className={`flex flex-col items-center space-y-3 pt-4 ${oauthSupported && onOAuthLogin ? 'border-t' : 'border-t'}`}>
            <p className="text-sm text-gray-500 text-center">
              想要快速体验？无需注册
            </p>
            <Button 
