          ...
          <div className="space-y-6">
            ...
            <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-xl hover:shadow-2xl transition-all duration-500 rounded-2xl overflow-hidden">
              <div className="bg-gradient-to-r from-purple-500 to-violet-600 p-6">
                ...
                <p className="text-purple-100 text-sm mt-2">挖掘故事深层主题意义</p>
              </div>
              <CardContent className="p-6 space-y-6">
                <div className="bg-gradient-to-r from-violet-50 to-purple-50 rounded-2xl p-5 border-l-4 border-violet-400">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-8 h-8 bg-violet-400 rounded-full flex items-center justify-center">
                      <Target className="h-4 w-4 text-white" />
                    </div>
                    <span className="font-bold text-violet-800 text-lg">主要主题</span>
                  </div>
                        ...
                        {isEditing ? (
                          <div className="flex items-center gap-2">
                            <Input
                              ...
                              className="h-8 text-sm w-24 bg-white/80 border-violet-200/50 rounded-xl"
                            />
                            <Button
                              size="sm"
                              variant="ghost"
                          ...
                          <Badge className="bg-gradient-to-r from-violet-500 to-purple-500 text-white px-3 py-1 text-sm rounded-full">
                            {theme}
                          </Badge>
                        )}
                      </div>
                ...
                <div className="bg-gradient-to-r from-indigo-50 to-blue-50 rounded-2xl p-5 border-l-4 border-indigo-400">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-8 h-8 bg-indigo-400 rounded-full flex items-center justify-center">
                      <Sparkles className="h-4 w-4 text-white" />
                    </div>
                    <span className="font-bold text-indigo-800 text-lg">深层含义</span>
                  </div>
                  {isEditing ? (
                    <Textarea
                      ...
                      placeholder="深层含义分析"
                      className="text-sm h-24 bg-white/80 border-indigo-200/50 rounded-xl"
                    />
                  ) : (
                    <p className="text-indigo-700 text-sm leading-relaxed">{data.themes.deeperMeaning}</p>
                  )}
                </div>
              </CardContent>
          </Card>
            ...
            <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-xl hover:shadow-2xl transition-all duration-500 rounded-2xl overflow-hidden">
              <div className="bg-gradient-to-r from-red-500 to-rose-600 p-6">
                ...
                <p className="text-red-100 text-sm mt-2">故事的冲突与关键转折</p>
              </div>
              <CardContent className="p-6 space-y-6">
                <div className="bg-gradient-to-r from-red-50 to-rose-50 rounded-2xl p-5 border-l-4 border-red-400">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-8 h-8 bg-red-400 rounded-full flex items-center justify-center">
                      <AlertCircle className="h-4 w-4 text-white" />
                    </div>
                    <span className="font-bold text-red-800 text-lg">主要冲突</span>
                  </div>
                  {isEditing ? (
                    <Textarea
                      ...
                      placeholder="主要冲突描述"
                      className="text-sm h-20 bg-white/80 border-red-200/50 rounded-xl"
                    />
                  ) : (
                ...
                <div className="bg-gradient-to-r from-orange-50 to-amber-50 rounded-2xl p-5 border-l-4 border-orange-400">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-8 h-8 bg-orange-400 rounded-full flex items-center justify-center">
                      <Clock className="h-4 w-4 text-white" />
                    </div>
                    <span className="font-bold text-orange-800 text-lg">关键事件</span>
                  </div>
                        ...
                        {isEditing ? (
                          <div className="flex-1 flex items-center gap-2">
                            <Input
                              ...
                              className="text-sm h-8 bg-white/80 border-orange-200/50 rounded-xl"
                              placeholder="关键事件"
                            />
                            <Button
                              size="sm"
                          ...
                          <span className="text-orange-700 text-sm font-medium flex-1">{event}</span>
                        )}
                      </div>
                    ))}
                  </div>
                ...
                <div className="bg-gradient-to-r from-cyan-50 to-teal-50 rounded-2xl p-5 border-l-4 border-cyan-400">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-8 h-8 bg-cyan-400 rounded-full flex items-center justify-center">
                      <Palette className="h-4 w-4 text-white" />
                    </div>
                    <span className="font-bold text-cyan-800 text-lg">叙事技巧</span>
                  </div>
                  {isEditing ? (
                    <Textarea
                      ...
                      placeholder="叙事技巧描述"
                      className="text-sm h-20 bg-white/80 border-cyan-200/50 rounded-xl"
                    />
                  ) : (
                    <p className="text-cyan-700 text-sm leading-relaxed">{data.plotElements.narrativeTechniques}</p>
                  )}
                </div>
              </CardContent>
          </Card>
