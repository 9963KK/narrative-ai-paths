...
import { UserLevelManagementTab } from '@/components/admin/UserLevelManagementTab';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Tabs defaultValue="user-usage" className="space-y-6">
          <TabsList className="grid w-full grid-cols-5">
            ...
            <TabsTrigger value="user-level-management" className="flex items-center gap-2">
          ...
          {/* 用户等级管理标签页 */}
          <TabsContent value="user-level-management">
            <UserLevelManagementTab />
          </TabsContent>
        </Tabs>
      </div>
    </div>
